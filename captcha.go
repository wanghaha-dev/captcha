...
func (receiver *captcha) GetBase64Encode(codeLength int) (code string, result string) {
	code = receiver.getRandStr(codeLength)

	data := receiver.imgText(280, 100, code)
	result = base64.StdEncoding.EncodeToString(data)
	result = "data:image/jpg;base64," + result
	return
}

func (receiver *captcha) SaveFile(filepath string, codeLength int) error {
	code := receiver.getRandStr(codeLength)
	data := receiver.imgText(280, 100, code)
...
func (receiver *captcha) getRandStr(n int) (randStr string) {
...
func (receiver *captcha) imgText(width, height int, text string) (b []byte) {
	textLen := len(text)
...
// 渲染文字
func (receiver *captcha) writeText(dc *gg.Context, text string, x, y float64) {
...
// 随机坐标
func (receiver *captcha) getRandPos(width, height int) (x float64, y float64) {
...
// 随机颜色
func (receiver *captcha) getRandColor(maxColor int) (r, g, b, a int) {
...
// 随机颜色范围
func (receiver *captcha) getRandColorRange(miniColor, maxColor int) (r, g, b, a int) {
...
// 加载字体
func (receiver *captcha) loadFontFace(points float64) font.Face {
